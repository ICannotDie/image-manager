...
export default function DirectoryManager({ onClose }: DirectoryManagerProps) {
  ...
  return (
    <div className="fixed inset-0 bg-black/95 flex items-center justify-center z-50 p-4">
      <div className="bg-gray-900 border border-gray-600 rounded-lg shadow-2xl w-full max-w-4xl max-h-[85vh] overflow-hidden">
        {/* Header */}
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                  <div>
                    ...
                    <input
                      ...
                      className="w-full bg-gray-700 border border-gray-500 text-white px-3 py-2 rounded focus:ring-1 focus:ring-blue-500 focus:border-blue-500"
                ...
                <div className="flex justify-between items-start">
                  <div className="flex-1">
                    ...
                    <div className="flex space-x-4 text-xs text-gray-400">
                      <span>{directory.imageCount || 0} images</span>
                      <span>{(directory as any).totalSize ? formatBytes((directory as any).totalSize) : '0 Bytes'}</span>
